...
export const IconMail = forwardRef<SVGSVGElement, SVGProp>(
  ({ className, solid, ...props }, ref) => (
    <svg
      ...
      ref={ref}
      className={cn('strokeWidthduration-200 ease-linear', className)}
      {...props}
    >
      {solid ? (
        <>
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            className={cn(
              'h-2 w-2 rounded-full bg-gray-400 ring-gray-500 ring-1 border-none ring-offset-2 ring-offset-card',
