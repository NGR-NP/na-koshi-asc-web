...
export default function FooterSection() {
  return (
    <footer className="bg-muted text-foreground static px-section-sm md:px-section-md left-0 right-0 bottom-0 max-md:mb-12">
      <div className="mx-auto w-full max-w-screen-2xl">
        ...
        <div className="px-4 py-6 bg-popover/70 md:flex md:items-center md:justify-between">
      ...
      {map.map((link) => {
        ...
        return (
          <ActivePathnameHighliter key={link.href} href={link.href}>
            <li
              key={link.href}
              className="mb-4 dark:hover:text-slate-200 hover:text-slate-900"
            >
              {isExternal ? (
                <a
                  href={link.href}
